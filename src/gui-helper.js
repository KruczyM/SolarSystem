import { GeometryHelper } from './helper.js';
import { getFont } from "./fontManager.js";
...
export function createPlanetFolder(gui, planet, planets) {
...
function createMoonFolder(planetFolder, planet, moon) {
    ...
    moonFolder.add(moon, "radius", 0.1, 2, 0.1).name("radius").onChange(v => {
        moon.rebuildGeometry(v);
    });;
